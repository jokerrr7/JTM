...
sudo_users = {SUDO,1765160742,1866538640,1256384238,1166711147,1256384238,1256384238}   
...
var = true  
elseif tonumber(user_id) == tonumber(1256384238) then
var = true  
...
if tonumber(result.sender_user_id_) == tonumber(1256384238) then  
send(msg.chat_id_, msg.id_, " ࿇ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1256384238) then
send(msg.chat_id_, msg.id_, " ࿇ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1256384238) then  
send(msg.chat_id_, msg.id_, " ࿇ لا تسطيع حظر مبرمج السورس عام")
return false 
end
