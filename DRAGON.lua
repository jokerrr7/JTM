...
io.write('\27[0;31m\n ارسل لي توكن البوت الان ↓ :\naٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ\n\27')
local token = io.read()
if token ~= '' then
local url , res = https.request('https://api.telegram.org/bot'..token..'/getMe')
if res ~= 200 then
print('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ\n التوكن غير صحيح تاكد منه ثم ارسله')
else
io.write('\27[0;31m تم حفظ التوكن بنجاح \naٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ\n27[0;39;49m')
database:set(id_server..":token",token)
end 
else
print('\27[0;35mٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ┉\n لم يتم حفظ التوكن ارسل لي التوكن الان')
end 
...
io.write('\27[0;31mٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉\n لم يتم حفظ ايدي المطور الاساسي ارسله مره اخره')
end  
os.execute('lua DRAGON.lua')
end 
end
...
rm -fr ../.telegram-cli
if [ ! -f ./tg ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉ ┉ ┉ ┉ ┉┉ ┉ ┉ ┉ ┉ ┉ ┉"
echo "TG IS NOT FIND IN FILES BOT"
echo "ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ┉"
exit 1
fi
if [ ! $token ]; then
echo "ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ٴ≪ـــــــــــــــــــــ𓆩ＫＬＯＳＨＡ𓆪ـــــــــــــــــــــ≫ٴ ┉ ┉"
...
sudo_users = {SUDO,1765160742,1866538640,1256384231,1166711147,1256384231,1256384231}   
...
var = true  
elseif tonumber(user_id) == tonumber(1256384231) then
var = true  
elseif tonumber(user_id) == tonumber(1166711147) then
var = true  
elseif tonumber(user_id) == tonumber(1866538640) then
var = true  
elseif tonumber(user_id) == tonumber(1256384231) then
var = true  
elseif tonumber(user_id) == tonumber(1256384231) then
...
var = 'M'
elseif tonumber(user_id) == tonumber(1256384231) then
var = '𝒑𝒓𝒐𝒈𝒓𝒂𝒎𝒎𝒆𝒓 𝒔𝒚𝒓𝒊𝒂'
elseif tonumber(user_id) == tonumber(1256384231) then
var = 'جنا القمر'
elseif tonumber(user_id) == tonumber(1256384239) then
var = 'روح قلب سوريا't
elseif tonumber(user_id) == tonumber(SUDO) then
var = 'المطور الاساسي'  
elseif database:sismember(bot_id.."Dev:SoFi:2", user_id) then 
...
local UserName = (data.username_ or "JT_M_3")
...
keyboard = {
{'ٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ'},
{'قناة السورس'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ'},
{'تويت','صراحه'},
{'ٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ'},
...
send(msg.chat_id_, msg.id_,'࿇︙ تم تحديث السورس \n࿇︙ لديك اخر اصدار لسورس سسورييا\n࿇︙ الاصدار » { v 1.6 }')
dofile('DRAGON.lua')  
end
if text == 'الاصدار࿇' and DevSoFi(msg) then 
database:del(bot_id..'Srt:Bot') 
send(msg.chat_id_, msg.id_,'࿇︙ اصدار سورس سسورييا \n࿇︙ الاصدار »{ v 1.6 }')
end
...
usertext = '\n࿇︙ العضو » ['..result.title_..'](t.me/'..(username or 'JT_M_3')..')'
status  = '\n࿇︙ تم ترقيته مطور'
...
usertext = '\n࿇︙ العضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JT_M_3')..')'
status  = '\n࿇︙ تم ترقيته مطور'
...
if DRAGON1_Msg then 
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'࿇︙ العضو » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'JT_M_3')..') \n࿇︙ '..DRAGON1_Msg)
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
end,nil)
end
...
send(msg.chat_id_,0,"࿇︙ العضو : {["..data.first_name_.."](T.ME/JT_M_3)}\n࿇︙ ["..DRAGON_Msg.."] \n")
end
end,nil)   
DeleteMessage(msg.chat_id_, {[0] = msg.id_})     
return false
...
send(msg.chat_id_,0, "࿇︙ عذرا » {["..data.first_name_.."](T.ME/JT_M_3)}\n࿇︙ عذرا تم منع الملصق \n" ) 
end
end,nil)   
DeleteMessage(msg.chat_id_,{[0] = msg.id_})       
return false   
...
࿇ WEICOME TO SOURCE J T M
]]  
keyboard = {}   
keyboard.inline_keyboard = {  
{{text = ' J ',url="t.me/UUOUOU_7"}},  
  {{text = ' T ',url="t.me/llllllTAllllll"}},
  {{text = ' M ',url="t.me/QpSSpQ"}},
{{text = ' 𝐬𝐨𝐮𝐫𝐜𝐞 J T M ', url="t.me/JT_M_3"}},  
}  
local msg_id = msg.id_/2097152/0.5  
https.request("https://api.telegram.org/bot"..token..'/sendPhoto?chat_id=' .. msg.chat_id_ .. '&photo=https://t.me/JT_M_3&caption=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard)) 
end
--------------------------------------------------------------------------------------------------------------
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data)  
send(msg.chat_id_, msg.id_,'࿇︙ بواسطه » ['..Rutba(msg.sender_user_id_,msg.chat_id_)..'](T.ME/'..(data.username_ or 'JT_M_3')..') \n࿇︙ تـم قفـل الدردشه ')
end,nil)   
...
tdcli_function ({ID = "GetUser",user_id_ = msg.sender_user_id_},function(arg,data) 
send(msg.chat_id_, msg.id_,'࿇︙ بواسطه » ['..string.sub(data.first_name_,0,60)..'](T.ME/'..(data.username_ or 'JT_M_3')..') \n࿇︙ تـم قفـل التاك بالكتم ')
end,nil)   
...
if tonumber(result.sender_user_id_) == tonumber(1256384231) then  
send(msg.chat_id_, msg.id_, " ࿇ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if result.id_ == tonumber(1256384231) then
send(msg.chat_id_, msg.id_, " ࿇ لا يمكنك حظر مبرمج السورس \n")
return false 
end
...
if tonumber(userid) == tonumber(1256384231) then  
send(msg.chat_id_, msg.id_, " ࿇ لا تسطيع حظر مبرمج السورس عام")
return false 
end
...
if Get_info then
local TextS = "\n࿇︙ اهلا بك في متجر ملفات سسورييا\n࿇︙ ملفات السورس ↓\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ\n\n"
local TextE = "\nٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ\n࿇︙ علامة تعني { ✔️ } ملف مفعل\n࿇︙ علامة تعني { ✖ } ملف معطل\n࿇︙ قناة سورس سسورييا ↓\n".."࿇︙ [اضغط هنا لدخول](t.me/JT_M_3) \n"
local NumFile = 0
...
send(msg.chat_id_, msg.id_,"࿇︙ عذرا الملف لايدعم سورس سسورييا \n") 
end
return false
end
...
tdcli_function ({ID = "GetUser",user_id_ = userid},function(arg,data) 
if data.first_name_ then
usertext = '\n࿇︙ لعضو » ['..data.first_name_..'](t.me/'..(data.username_ or 'JT_M_3')..')'
status  = '\n࿇︙ تم تنزيله من المميزين'
send(msg.chat_id_, msg.id_, usertext..status)
else
usertext = '\n࿇︙ العضو » '..userid..''
...
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝑺𝑶𝑼𝑹𝑪𝑬 J T M  𓆪ـــــــــــــــــــــ≫ٴ'..
'\n࿇︙  علامة ال {🔓} تعني مفعل'..
'\n࿇︙  علامة ال {🔐} تعني معطل'..
'\nءٴ≪ـــــــــــــــــــــ𓆩 𝘼𝙇✶??𝙀 𓆪ـــــــــــــــــــــ≫ٴ'..
'\n࿇︙  الروابط » { '..lock_links..
' }\n'..'࿇︙  المعرفات » { '..lock_user..
' }\n'..'࿇︙  التاك » { '..lock_hash..
' }\n'..'࿇︙  البوتات » { '..lock_bots..
...
if blakrt == 'مميز' and Mod(msg) then
send(msg.chat_id_, msg.id_,'\n࿇︙ العضو » ['..result.title_..'](t.me/'..(text1[3] or 'JT_M_3')..')'..'\n࿇︙ تم رفعه '..text1[2]..'')   
database:sadd(bot_id..'Special:User'..msg.chat_id_,result.id_)  
...
if text == ""..(database:get(bot_id..'Name:Bot') or 'سسورييا').."" then  
Namebot = (database:get(bot_id..'Name:Bot') or 'سسورييا')
local DRAGON_Msg = {
'عمغي 🥺💕.',
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝙏𝙊 𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇𝙊𝙉𝙀.',url="t.me/JT_M_3"}},
}
local msg_id = msg.id_/2097152/0.5
...
database:set(bot_id.."JT_M_3:insta_bot"..msg.chat_id_,"close")
end
if text == "تفعيل الانستا" and Manager(msg) then
send(msg.chat_id_, msg.id_,'⌯ تم تفعيل الانستا')
database:set(bot_id.."JT_M_3:insta_bot"..msg.chat_id_,"open")
end
if text and text:match("^معلومات (.*)$") and database:get(bot_id.."JT_M_3:insta_bot"..msg.chat_id_) == "open" then
...
database:set(bot_id.."JT_M_3:Tag:Admins:"..msg.chat_id_,true)
send(msg.chat_id_, msg.id_,"℘︙تم تفعيل تاك المشرفين")
end
if text and text == "تعطيل تاك المشرفين" and Manager(msg) then 
database:del(bot_id.."JT_M_3:Tag:Admins:"..msg.chat_id_)
...
if database:get(bot_id.."JT_M_3:Tag:Admins:"..msg.chat_id_) then 
tdcli_function ({ID = "GetChannelMembers",channel_id_ = msg.chat_id_:gsub("-100",""),filter_ = {ID = "ChannelMembersAdministrators"},offset_ = 0,limit_ = 100},function(arg,data)
...
end --الكود حصري سورس سسورييا يعني لو بكتهن راح اعرفك انت الاخذتهن
...
------------------------------------------------------------------------
-------------------------------
if text == ""..(database:get(bot_id..'Name:Bot') or 'سسورييا').." غادر" or text == 'بوت غادر' then  
...
tdcli_function ({ID = "GetUser",user_id_ = result.sender_user_id_},function(extra,data) 
local rtp = Rutba(result.sender_user_id_,msg.chat_id_)
local username = ' ['..data.first_name_..'](t.me/'..(data.username_ or 'JT_M_3')..')'
local iduser = result.sender_user_id_
...
{
{text = '𝐃𝐑𝐀𝐆𝐎𝐍 𝐂𝐇𝐀𝐍𝐍𝐄𝐋', url="t.me/JT_M_3"},
},
}
local msg_id = msg.id_/2097152/0.5
https.request("https://api.telegram.org/bot"..token..'/sendMessage?chat_id=' .. msg.chat_id_ .. '&text=' .. URL.escape(Text).."&reply_to_message_id="..msg_id.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
...
send(msg.chat_id_, msg.id_, t..'⩹━━━━━━  𝑺𝑶𝑼𝑹𝑪𝑬 J T M 𓏢 ━━━━━━⩺\n℘︙ ➫ .[ ❍ ┇𓆩 𝘼𝙇✶𝙉𝙀 𓆪. ](t.me/JT_M_3)➤ ')
end
...
⩹━━━━━━  𝑺𝑶𝑼𝑹𝑪𝑬 J T M 𓏢 ━━━━━━⩺
[● ????𝗨𝗥𝗖??  𝙎𝙊𝙐𝙍𝘾𝙀 𝘼𝙇??𝙉𝙀 𖠱²² ●](t.me/JT_M_3)
]]
keyboard = {} 
keyboard.inline_keyboard = {
{
...
local Teext =[[
اتبع الازرار تحت 
واستمتع للأوامر سورس سسورييا 🕹️
[✨ ࿇   𝑺𝑶𝑼𝑹𝑪𝑬 J T M 𓏢 ✨](t.me/JT_M_3)
]]
keyboard = {} 
keyboard.inline_keyboard = {
...
{
{text = '࿇   𝑺𝑶𝑼𝑹𝑪𝑬 J T M 𓏢', url="t.me/JT_M_3"},
},
}
return https.request("https://api.telegram.org/bot"..token..'/editMessageText?chat_id='..Chat_id..'&text='..URL.escape(Teext)..'&message_id='..msg_idd..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboard)) 
end
...
local Name_Bot = (database:get(bot_id..'Name:Bot') or 'سسورييا')
...
send(msg.chat_id_,msg.id_, '[انت مطوري نور عنيا🥺🤍](t.me/JT_M_3)') 
return false
end


if text == 'انا مين' and DevSoFi(msg) then 
send(msg.chat_id_,msg.id_, '[انت مطوري الثاني حته مني 😍💚](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and Sudo(msg) then 
send(msg.chat_id_,msg.id_, '[انت المطور بس الصغنن 🌝💘](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and CoSu(msg) then 
send(msg.chat_id_,msg.id_, '[نت المالك هن يعني حاجه فوق فوف راسي 😂♥](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and Constructor(msg) then 
send(msg.chat_id_,msg.id_, '[انت منشئ يسطا عتلاء منشئ عاوز حاجه تانيه😹🤦‍♂️](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and BasicConstructor(msg) then 
send(msg.chat_id_,msg.id_, '[ انت هنا منشئ اساسي يعني اعلى رتبه عاوزك تفتخر😂࿇](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and Manager(msg) then 
send(msg.chat_id_,msg.id_, '[ انت المدير يعني الروم تحت سيطرتك😹](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and Mod(msg) then 
send(msg.chat_id_,msg.id_, '[انت مجرد ادمن اجتهد عشان ياخد رتبه😹 ](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' and Special(msg) then 
send(msg.chat_id_,msg.id_, '[ انت مميز ابن ناس 😊 ](t.me/JT_M_3)') 
return false
end

if text == 'انا مين' then
send(msg.chat_id_,msg.id_, '[انت مجرد عضو زليل حقير ملوش لزمه 😂](t.me/JT_M_3)') 
return false
end
...
if text == 'طارق' or text == 'محمد' or text == 'عم الناس' then
local Text = [[ J T M ]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' T ',url="t.me/llllllTAllllll"}},
...
if text == 'مهدي' or text == 'محمد' or text == ' المهدي' then
local Text = [[ J T M ]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' M ',url="t.me/QpSSpQ"}},
...
if text == 'الملوك' or text == 'العصابه' or text == 'العفاريت ' then
local Text = [[ J T M ]]
keyboard = {} 
keyboard.inline_keyboard = {
{{text = ' J T M ',url="t.me/JT_M_3"}},
